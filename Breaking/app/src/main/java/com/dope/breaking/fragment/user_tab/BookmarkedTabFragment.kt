...
class BookmarkedTabFragment : Fragment() {
    ...
    private val requestOption = "bookmark" // 현재 Fragment 의 옵션 - 북마크한 제보글
    ...
    override fun onCreateView(
        ...
        // 리사이클러 뷰 divider
        binding.rcvUserBookmarked.addItemDecoration(
        ...
        processGetUserFeed(userId!!, 0, ValueUtil.FILTER_SELL_OPTIONS[0], token, {
            ...
            /*
                스크롤 이벤트
             */
            binding.rcvUserBookmarked.addOnScrollListener(object : RecyclerView.OnScrollListener() {
    ...
    private fun showSkeletonView() {
        binding.rcvUserBookmarked.visibility = View.GONE
    ...
    private fun dismissSkeletonView() {
        ...
        binding.rcvUserBookmarked.visibility = View.VISIBLE
    }
